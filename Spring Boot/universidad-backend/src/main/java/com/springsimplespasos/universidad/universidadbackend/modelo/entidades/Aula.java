...
public class Aula implements Serializable {
   ...
   private Pabellon pabellon;
    ...
    public Aula(Integer id, Integer nroAula, String medidas, Integer cantidadPupitres, Pizarron pizzaron) {
        this.id = id;
    ...
    public Pizarron getPizzaron() {
        return pizzaron;
    }

    public void setPizzaron(Pizarron pizzaron) {
        this.pizzaron = pizzaron;
    }
