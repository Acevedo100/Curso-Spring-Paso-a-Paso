...
// Se crear esta clase que implementa los metodos del GenericoDAO
public class GenericoDAOImpl <E, R extends CrudRepository<E, Integer>> implements GenericoDAO<E> {


    protected final R repository; // Se crea el objeto de tipo Repository, Este sera el que return.
